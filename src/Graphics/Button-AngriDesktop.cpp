...
#include "Button.hpp"
#include "Label.hpp"
Button::Button(lv_obj_t* screen, lv_action_t ButtonMethod, std::string text, int buttonNum, lv_color_t buttonColor, lv_align_t alignment, lv_coord_t shiftX = 0, lv_coord_t shiftY = 0, int sizeX = 100, int sizeY = 100){
...
void Button::setColor(lv_color_t buttonColor){
    //create style for released button
    lv_style_t styleReleased;
    lv_style_copy(&styleReleased, &lv_style_plain);
    styleReleased.body.main_color = buttonColor;
