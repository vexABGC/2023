...
void Initialize(){
    ...
    createButton(5, 160, 80, 0, 0,  LV_COLOR_WHITE, LV_ALIGN_IN_BOTTOM_MID, "X Position:");
    createButton(6, 160, 80, 0, 0,  LV_COLOR_WHITE, LV_ALIGN_IN_BOTTOM_RIGHT, "Y Position:");
